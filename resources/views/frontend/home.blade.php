...
<!-- header ends here -->
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('front/images/lg_view.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Brgy. San Gabriel Official Website</h1>
              <p>San Gabriel, San Pablo City , Laguna</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mb-5 justify-content-center text-center">
          <div class="col-lg-4 mb-5">
            <h2 class="section-title-underline mb-5">
              <span>PLEASE CHOOSE FROM THE FOLLOWING SERVICES</span>
            </h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/brgy_id.jpg')}}" alt="Image" class="img-fluid">
              Request for Brgy. ID
            </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/complaint_box.jpg')}}" alt="Image" class="img-fluid">
              Request for Complaint / Blotter
            </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/cedula.jpg')}}" alt="Image" class="img-fluid">
             Request for Cedula
            </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/residential_permit.jpg')}}" alt="Image" class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/cert_of_residency.jpg')}}" alt="Image" class="img-fluid">
              Request for Certificate of Residency
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/bs_permit.jpg')}}" alt="Image" class="img-fluid">
              Request for Business Permit
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <a href="news-single.html" class="img-link"><img src="{{ url('front/images/brgy_clearance.jpg')}}" alt="Image" class="img-fluid">
             Request for  Brgy. Clearance
            </a> 
          </div>
...
<!--     delete din tong below pag inayos -->
</div>
</div>
<!-- footer starts -->
