  ...
  <!-- content-wrapper ends -->
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Baranggay San. Gabriel, San. Pablo City, Laguna</span>
          </div>
          <span class="text-muted d-block text-center text-sm-left d-sm-inline-block mt-2">Distributed By: Mark Allen Salonga Simon </a></span> 
        </footer>
